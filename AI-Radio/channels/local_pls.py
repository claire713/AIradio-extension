...
Deliver a spoken, radio-style daily special segment for an ongoing broadcast.
Greet {name} by name, Give facts about their interest in {interest}, reflect their current movement status while listening in : {self.status}, and subtly weave in this reminder: {reminder}.
Domain: Conversational radio broadcasting — warm, engaging, and natural in tone.

Constraints: ASCII characters only. No sound effects, stage directions, smart quotes, or special symbols. Approximately 100 words.
"""
		return seg_prompt
...
Deliver a spoken, radio-style daily introduction segment for an ongoing broadcast.
Greet {name} by name, reference their interests in {interests}, reflect their current movement status while listening in : {self.status}, and subtly weave in this reminder: {reminder}.
Domain: Conversational radio broadcasting — warm, engaging, and natural in tone.

Constraints: ASCII characters only. No sound effects, stage directions, smart quotes, or special symbols. Approximately 70 words.
"""
		return seg_prompt
